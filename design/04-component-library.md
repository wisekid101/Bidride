# BidiRide — Component Library v1.0
...
**Design Rule:** Driver earnings line is always shown in `text-gold`. Rider sees what driver makes — this is BidiRide's transparency promise. Never hide or remove this line.
...
- BidiRide XL (Phase 3): large vehicle option
...
**Purpose:** Inform driver that BidiRide's earnings floor protected their rate on a specific trip.
...
**Purpose:** Transparency. Driver should understand BidiRide enforced the floor on their behalf.
...
**Purpose:** Visual indicator that a fare was generated by BidiRide's AI system. Builds rider trust.
...
"BidiRide AI analyzes demand, traffic, weather, and driver supply to generate the fairest possible fare — protecting driver earnings while keeping costs low for riders."
...
**Purpose:** Show founder how well BidiRide's AI systems are performing.
...
**Purpose:** Show the rider how much they have saved on BidiRide vs estimated competitor pricing — reinforces the core value proposition.

```
╔══════════════════════════════════════════╗
║                                          ║
║  ┌──────────────────────────────────┐    ║
║  │  Your BidiRide Savings            │    ║
║  │  ─────────────────────────────── │    ║
║  │                                  │    ║
║  │       $84.20                     │    ║
...
**Purpose:** Show founder how BidiRide fares compare to estimated competitor pricing in the same market — validates the "riders pay less" promise.
...
**Important:** Always show the "estimated" disclaimer. BidiRide does not have access to live competitor APIs — this is AI-modeled market pricing.
...
*BidiRide Component Library — Confidential*
