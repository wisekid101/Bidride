 ...
 * admin-service's role grants kms:Sign / kms:GetPublicKey on the ADMIN JWT key
 * only — it cannot sign user-domain tokens (infrastructure/terraform/ecs-services.tf).
 *
