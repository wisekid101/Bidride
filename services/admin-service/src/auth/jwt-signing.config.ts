 ...
 *
 * This is the ADMIN copy: callers pass the admin keyset (JWT_ADMIN_PUBLIC_KEYS)
 * into assertSigningKeyMatchesKeyset, never the user keyset. The two trust domains
 * stay separate at issuance exactly as they do at verification.
 *
