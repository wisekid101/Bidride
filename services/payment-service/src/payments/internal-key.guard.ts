...
// Authenticates internal service-to-service calls to /payments/internal/*.
// Replicated verbatim from the proven ai-service guard (no shared guard package
// exists; sharing would require modifying ai-service, which is out of this
// batch's scope). Fail CLOSED in production, keyless-allowed only in
// development/test, constant-time comparison.
@Injectable()
