...
// Authenticates internal service-to-service calls to /internal/trust/*.
// Replicated verbatim from the proven ai-service/payment-service guard (no shared
// guard package exists). Fail CLOSED in production, keyless-allowed only in
